...
"<form action='/wifi'    method='get'><button>Подключить WiFi</button></form><br/>\n", // MENU_WIFI
"<form action='/0wifi'   method='get'><button>Подключить WiFi (без сканирования)</button></form><br/>\n", // MENU_WIFINOSCAN
"<form action='/info'    method='get'><button>Информация</button></form><br/>\n", // MENU_INFO
"<form action='/param'   method='get'><button>Инициализация</button></form><br/>\n",//MENU_PARAM
...
"<form action='/erase'   method='get'><button class='D'>Сбросить</button></form><br/>\n", // MENU_ERASE
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Сохранение данных<br/>Попытка подключения устройства к сети.<br />Если не удастся, переподключитесь к точке доступа, чтобы попробовать снова</div>";
...
const char HTTP_STATUS_OFF[]       PROGMEM = "<div class='msg {c}'><strong>Не подключено</strong> к {v}{r}</div>"; // {c=class} {v=ssid} {r=status_off}
...
const char HTTP_HELP[]             PROGMEM =
 ...
 "<tr><td><a href='/'>/</a></td>"
 "<td>Стартовое меню.</td></tr>"
 "<tr><td><a href='/wifi'>/wifi</a></td>"
 "<td>Показать результаты сканирования WiFi и ввести настройки WiFi.(/0wifi noscan)</td></tr>"
 "<tr><td><a href='/wifisave'>/wifisave</a></td>"
 "<td>Сохранить настройки WiFi и настроить устройство. Требуются переданные переменные.</td></tr>"
 "<tr><td><a href='/param'>/param</a></td>"
 "<td>Страница параметров</td></tr>"
 "<tr><td><a href='/info'>/info</a></td>"
 "<td>Страница информации</td></tr>"
 "<tr><td><a href='/u'>/u</a></td>"
 "<td>Обновление прошивки (OTA)</td></tr>"
 "<tr><td><a href='/close'>/close</a></td>"
 "<td>Закрыть всплывающее окно captive portal, портал конфигурации останется активным</td></tr>"
 "<tr><td>/exit</td>"
...
const char HTTP_UPDATE_SUCCESS[] PROGMEM = "<div class='msg S'><strong>Обновление прошло успешно.</strong> <br/> Устройство перезагружается...</div>";
...
// @todo remove html elements from progmem, repetetive strings
	...
	const char HTTP_INFO_chiprev[]    PROGMEM = "<dt>Ревизия чипа</dt><dd>{1}</dd>";
  	...
  	const char HTTP_INFO_aphost[]     PROGMEM = "<dt>Имя точки доступа</dt><dd>{1}</dd>";
	...
	const char HTTP_INFO_fchipid[]    PROGMEM = "<dt>ID флэш-чипа</dt><dd>{1}</dd>";
	...
	const char HTTP_INFO_flashsize[]  PROGMEM = "<dt>Реальный размер флэш-памяти</dt><dd>{1} байт</dd>";
#endif

const char HTTP_INFO_memsmeter[]  PROGMEM = "<br/><progress value='{1}' max='{2}'></progress></dd>";
const char HTTP_INFO_memsketch[]  PROGMEM = "<dt>Память - размер скетча</dt><dd>Использовано / Всего байт<br/>{1} / {2}";
const char HTTP_INFO_freeheap[]   PROGMEM = "<dt>Память - свободная heap</dt><dd>{1} байт доступно</dd>";
...
const char HTTP_INFO_idesize[]    PROGMEM = "<dt>Размер флэш-памяти</dt><dd>{1} байт</dd>";
const char HTTP_INFO_sdkver[]     PROGMEM = "<dt>Версия SDK</dt><dd>{1}</dd>";
const char HTTP_INFO_cpufreq[]    PROGMEM = "<dt>Частота CPU</dt><dd>{1}MHz</dd>";
...
const char HTTP_INFO_stasub[]     PROGMEM = "<dt>Сеть станции</dt><dd>{1}</dd>";
...
const char S_subnet[]             PROGMEM = "Сеть";
const char S_exiting[]            PROGMEM = "Выход";
const char S_resetting[]          PROGMEM = "Модуль будет сброшен через несколько секунд.";
